  ...
  return (
    ...
    About the platform
     ...
     <div className='lg:w-[85%]  md:w-[75%] lg:flex lg:justify-between  mt-20 m-auto'>
       ...
       <div>
        <div className='xs:flex xs:justify-center xs:items-center md:flex md:justify-center lg:flex lg:justify-start g:items-start md:items-center '>
    ...
    <p className='text-gray-300 xs:mt-4 md:text-center lg:text-start md:mt-4 xs:text-center'>Multiple Chains, One Home. Stack up all your NFTs from across blockchains.
